...
class TestCompany(unittest.TestCase):
    ...
    def test_officers(self):
        ...
        self.assertEqual(self.company.secretary, self.joris)
    ...
    def test_shares_can_be_issued_and_found(self):    
        ...
        self.assertEqual(all_shareholdings[1].shareholder, self.tonald)

        one_shareholding = all_joris_shares[0]
        self.assertIsInstance(one_shareholding, Shareholding)
        self.assertEqual(one_shareholding.shareholder, self.joris)
